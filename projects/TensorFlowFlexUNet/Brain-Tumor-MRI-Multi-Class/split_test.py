...
if __name__ == "__main__":
  try:
    images_dir = "./Mixed-Brain-Tumor-MRI-Regenerated-ImageMask-Dataset/test/images/"
    masks_dir  = "./Mixed-Brain-Tumor-MRI-Regenerated-ImageMask-Dataset/test/masks/"
    output_dir = "./mini_test_master/"
