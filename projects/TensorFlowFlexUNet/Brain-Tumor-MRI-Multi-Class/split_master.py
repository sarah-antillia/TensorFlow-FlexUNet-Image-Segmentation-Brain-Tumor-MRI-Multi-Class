...
if __name__ == "__main__":
  try:
    images_dir = "./Mixed-Brain-Tumor-MRI-Regenerated/images/"
    masks_dir  = "./Mixed-Brain-Tumor-MRI-Regenerated/masks/"
    output_dir = "./Mixed-Brain-Tumor-MRI-Regenerated-ImageMask-Dataset/"
